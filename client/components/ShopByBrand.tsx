...
const BRANDS = [
  ...
  { name: "AJIO", offer: "Upto 8% Refund", logo: "/brands/ajio.svg", bgColor: "bg-white" },
  { name: "Nykaa", offer: "Upto 10% Refund", logo: "/brands/nykaa.svg", bgColor: "bg-white" },
  { name: "Tata CLiQ", offer: "Upto 4% Refund", logo: "/brands/tatacliq.svg", bgColor: "bg-white" },
  { name: "Meesho", offer: "Upto 12% Refund", logo: "/brands/meesho.svg", bgColor: "bg-white" },
];
