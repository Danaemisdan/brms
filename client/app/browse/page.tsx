...
const FEATURED_SAMPLES = [
  { id: "1", title: "Wireless Earbuds: 100% Refund for Feedback", price: "₹25.00", image: "https://images.unsplash.com/photo-1505740420928-5e560c06d30e?q=80&w=300&auto=format&fit=crop", statusText: "Stk/160" },
  ...
  { id: "4", title: "Wireless Earbuds: 100% Refund for Feedback", price: "₹25.00", image: "https://images.unsplash.com/photo-1606220588913-b3aacb4d2f46?q=80&w=300&auto=format&fit=crop", statusText: "Stk/160" },
  ...
  return (
    <div className="container mx-auto px-6 py-12">
      <div className="flex justify-between items-center mb-8 border-b border-border pb-4">
        <h1 className="text-2xl font-bold font-heading">Sample Directory</h1>
      ...
      <div className="flex flex-col md:flex-row gap-8">
        ...
        <aside className="w-full md:w-64 flex-shrink-0">
          <div className="mb-8">
            <h3 className="font-bold mb-4 text-sm">Price</h3>
          ...
          <div>
            ...
            <div className="space-y-3">
              {['Minis', 'Full-Size', 'Tester Kits', 'Categories', 'Others'].map((cat, i) => (
